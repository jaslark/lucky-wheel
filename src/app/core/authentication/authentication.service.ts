/// <reference path="../model/authentication.model.ts" />
...
export class AuthenticationService {
  ...
  login(
    ...
    return this.httpClient.post(API_ENDPOINT.AUTH.LOGIN, payload).pipe(
  ...
  signup(
    ...
    return this.httpClient.post(API_ENDPOINT.AUTH.SIGNUP, payload).pipe(
  ...
  resetPassword(
    ...
    return this.httpClient.post(API_ENDPOINT.AUTH.RESET_PASSWORD, payload).pipe(
      map((body: Authentication.User) => {
        return body;
      })
    );
  ...
  getKey() {
    return this.httpClient
      .get(`${API_ENDPOINT.MASTER_DATA.SETUP_COMPANY}/is_install`)
      .pipe(
        map((body: any) => {
          return body;
        })
